...
data class CreatemssgComnGalleryStruct(
  val commun_code: CyberSymbolCode,
  val message_id: MssgidComnGalleryStruct,
  val parent_id: MssgidComnGalleryStruct,
  ...
  val getParentId: MssgidComnGalleryStruct
    @ChildCompress
    get() = parent_id
  ...
  fun toHex() = AbiBinaryGenCyber(CompressionType.NONE)
                 .squishCreatemssgComnGalleryStruct(this)
                 .toHex()
  fun toActionAbi(
    contractName: String,
    actionName: String,
