...
data class BlockSummaryObjectCyberStruct(
  val id: Long,
  val block_id: CheckSum256
) {
  val structName: String = "block_summary_object"

  val getId: Long
    @LongCompress
    get() = id

  val getBlockId: CheckSum256
    @CheckSumCompress
    get() = block_id

  fun toHex() = AbiBinaryGenCyber(CompressionType.NONE)
                 .squishBlockSummaryObjectCyberStruct(this)
                 .toHex()
  fun toActionAbi(
    contractName: String,
    actionName: String,
