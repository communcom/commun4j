...
data class ActionCyberMsigStruct(
  val account: CyberName,
  val name: CyberName,
  val authorization: List<PermissionLevelCyberMsigStruct>,
  val data: ByteArray
) {
  ...
  val getAuthorization: List<PermissionLevelCyberMsigStruct>
    @CollectionCompress
    get() = authorization
  ...
  fun toHex() = AbiBinaryGenCyber(CompressionType.NONE)
                 .squishActionCyberMsigStruct(this)
                 .toHex()
  fun toActionAbi(
    contractName: String,
    actionName: String,
