...
data class TransactionCyberMsigStruct(
  ...
  val context_free_actions: List<ActionCyberMsigStruct>,
  val actions: List<ActionCyberMsigStruct>,
  val transaction_extensions: List<ExtensionCyberMsigStruct>
) {
  ...
  val getContextFreeActions: List<ActionCyberMsigStruct>
    @CollectionCompress
    get() = context_free_actions

  val getActions: List<ActionCyberMsigStruct>
    @CollectionCompress
    get() = actions

  val getTransactionExtensions: List<ExtensionCyberMsigStruct>
    @CollectionCompress
    get() = transaction_extensions

  fun toHex() = AbiBinaryGenCyber(CompressionType.NONE)
                 .squishTransactionCyberMsigStruct(this)
                 .toHex()
  fun toActionAbi(
    contractName: String,
    actionName: String,
