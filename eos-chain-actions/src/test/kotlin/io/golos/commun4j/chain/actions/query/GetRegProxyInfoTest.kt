...
class GetRegProxyInfoTest : Spek({
    ...
    given("an Api") {
        ...
        on("v1/chain/get_table_rows -> proxies") {
            ...
            val page1Response = io.golos.commun4j.chain.actions.query.proxy.GetRegProxyInfo(chainApi).getProxies(100).blockingGet()
            val page2Response = io.golos.commun4j.chain.actions.query.proxy.GetRegProxyInfo(chainApi).getProxies(100, page1Response.last().owner).blockingGet()
        ...
        on("v1/chain/get_table_rows -> single proxy") {
            ...
            val proxyInfo = io.golos.commun4j.chain.actions.query.proxy.GetRegProxyInfo(chainApi).getProxy("amazinggamer").blockingGet()
